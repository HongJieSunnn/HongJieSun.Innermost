namespace Innermost.TagServer.API.Referrers
{
    /// <summary>
    /// LifeRecordReferrer here is same as the LifeRecordReferrer in LogLife.This class is to avoid use the reference of Innermost.LogLife.API
    /// </summary>
