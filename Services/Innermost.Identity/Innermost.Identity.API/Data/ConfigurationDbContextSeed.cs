using Innermost.Identity.API.Configurations;
...
namespace Innermost.Identity.API.Data
{
    ...
    public class ConfigurationDbContextSeed
    {
        ...
        public async Task SeedAsync(ConfigurationDbContext db, IConfiguration configuration)
        {
            ...
            redirectUrls.Add("ReactAppClient", configuration["RedirectUrls:ReactAppClient"]);
            redirectUrls.Add("ReactApp", configuration["RedirectUrls:ReactApp"]);
            redirectUrls.Add("ReactAppLogout", configuration["RedirectUrls:ReactAppLogout"]);
