namespace Innermost.MusicHub.API.Queries.SingerQueries.Models
{
    public class SingerAlbumDTO
    {
        ...
        public SingerAlbumDTO(string mid, string albumName, string albumDescriptions, string albumGenre, string albumLanguage, int albumSongCount, string publishCompany, string publishTime)
        {
            Mid = mid;
            AlbumName = albumName;
