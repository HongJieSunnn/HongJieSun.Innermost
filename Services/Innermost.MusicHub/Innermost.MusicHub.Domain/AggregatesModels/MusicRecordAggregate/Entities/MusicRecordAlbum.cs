namespace Innermost.MusicHub.Domain.AggregatesModels.MusicRecordAggregate.Entities
{
    public class MusicRecordAlbum : Entity<string>
    {
        ...
        public MusicRecordAlbum(string mid,string albumName,string albumDescriptions,string albumGenre,string albumLanguage,int albumSongCount,string publishCompany,string publishTime)
        {
            Id = mid;
            AlbumName = albumName;
