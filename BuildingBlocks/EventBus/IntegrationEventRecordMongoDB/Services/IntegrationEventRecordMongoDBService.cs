namespace IntegrationEventRecordMongoDB.Services
{
    public class IntegrationEventRecordMongoDBService : IIntegrationEventRecordMongoDBService
    {
        ...
        public IntegrationEventRecordMongoDBService(IMongoDatabase database)
        {
        ...
        {
            var recordCursor= await _integrationEvents.FindAsync(e => eventIds.Contains(e.EventId));
        ...
        public Task MarkEventAsInProcessAsync(Guid eventId)
        {
            ...
            return _integrationEvents.UpdateOneAsync(e => e.EventId == eventId, update);
        }
        ...
        public Task SaveEventAsync(IntegrationEvent @event)
        {
            ...
            return _integrationEvents.InsertOneAsync(eventModel);
        }
    }
}
