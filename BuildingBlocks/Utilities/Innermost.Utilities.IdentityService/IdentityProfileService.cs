...
namespace Innermost.IdentityService
{
    ...
    public class IdentityProfileService : IdentityServiceBase, IIdentityProfileService
    {
        private readonly IdentityProfileGrpc.IdentityProfileGrpcClient _identityUserGrpcClient;
        public IdentityProfileService(IHttpContextAccessor httpContextAccessor, IdentityProfileGrpc.IdentityProfileGrpcClient identityUserGrpcClient)
